...
export const HRMUDashboard: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-3xl font-extrabold text-white drop-shadow-md tracking-tight">HRMU Analytics</h2>
          <p className="text-blue-100 font-medium opacity-90">Comprehensive overview of IPCR performance and compliance.</p>
        </div>
